...
JFactory::getLanguage()->load('com_forsales', JPATH_ADMINISTRATOR.'/components/com_forsales');
...
<script type="text/javascript">
	Joomla.submitbutton = function(task) {
		if (task == 'forsale.cancel' || document.formvalidator.isValid(document.id('adminForm'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_forsales&a_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	<fieldset>
        ...
        <div class="formelm-buttons">
            <button type="button" onclick="Joomla.submitbutton('forsale.save')">
                <?php echo JText::_('JSAVE') ?>
            </button>
            <button type="button" onclick="Joomla.submitbutton('forsale.cancel')">
