...
abstract class JFoobarsHelperRoute
{
	...
	public static function getJFoobarRoute($id, $catid = 0)
	{
		...
		//Create the link
		$link = 'index.php?option=com_forsales&view=foobar&id='. $id;
		if ((int)$catid > 1)
		{
	...
	public static function getFormRoute($id)
	{
		//Create the link
		if ($id) {
			$link = 'index.php?option=com_forsales&task=forsale.edit&a_id='. $id;
		} else {
			$link = 'index.php?option=com_forsales&task=forsale.edit&a_id=0';
		}
	...
	protected static function _findItem($needles = null)
	{
		...
		else
		{
			...
			if ($active && $active->component == 'com_forsales') {
				return $active->id;
			}
		}
