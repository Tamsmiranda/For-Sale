 ...
 * forsale Table class
 */
class ForsalesTableForsale extends JTable
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__forsales', 'id', $db);
    }
    ...
    {
        if (trim($this->title) == '') {
            $this->setError(JText::_('COM_FORSALES_WARNING_PROVIDE_VALID_NAME'));
            return false;
        }
    ...
    public function store($updateNulls = false)
    {
        ...
        if ($this->id) {
            ...
            // New forsale. An forsale created and created_by field can be set by the user,
        ...
        if ($table->load(array('alias'=>$this->alias,'catid'=>$this->catid)) && ($table->id != $this->id || $this->id==0)) {
            $this->setError(JText::_('JLIB_DATABASE_ERROR_FORSALE_UNIQUE_ALIAS'));
            return false;
        }
