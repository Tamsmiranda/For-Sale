CREATE TABLE IF NOT EXISTS `#__forsales` (
  ...
  `price` double(11) unsigned NOT NULL DEFAULT '0',
  `bedroom` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `bathroom` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `parking_spot` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `area` double(11) unsigned NOT NULL DEFAULT '0',
  ...
  `featured` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT 'Set if forsale is featured.',
